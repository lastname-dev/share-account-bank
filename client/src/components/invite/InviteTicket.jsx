  ...
  return (
    <>
      <div class="boarding-pass">
        <header>
          <div class="logo">
            <img src={process.env.PUBLIC_URL + "/image/shinhanlogo.png"} height="30" width="30" />
          </div>
          <div class="flight">
            <small>Shinhan</small>
        ...
        <section class="cities">
          <div class="city">
            ...
            <span style={{ fontSize: "2.5rem" }}>shinhan</span>
          </div>
          <div class="city">
            <small>ssafy</small>

            <span style={{ fontSize: "2.5rem" }}>SSAFY</span>
          </div>
          <svg class="airplane">
        ...
        <section class="infos">
          <div class="places">
            ...
            <div class="box">
              <small>Goal</small>
              <strong>
                <em>{setMoneyRegex(group.goal)}</em>
              </strong>
            </div>
            <div class="box">
              <small>Inviter</small>
              <strong>{group.inviter}</strong>
            </div>
            <div class="box">
              <small>Class</small>
              <strong>S</strong>
        ...
        <section class="strap">
          <div class="box">
            <div>
              <div class="passenger">
                <small>자동이체일</small>
                <strong>매월 {group.duesDate}일</strong>
              </div>
              <div class="date">
                <small>회비</small>
                <strong>{setMoneyRegex(group.dues)}원</strong>
              </div>
            </div>
          </div>
