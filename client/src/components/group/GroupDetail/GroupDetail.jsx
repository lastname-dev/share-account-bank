...
const GroupDetail = ({ dues, duesDate, startDate, limitMember, participants, goal }) => {
  ...
  return (
    <S.GroupDetailWrapper>
      <S.GroupDetailTitle>모임정보</S.GroupDetailTitle>
      <S.DetailContainer>
        <S.DetailKey>목표금액</S.DetailKey>
        <S.DetailValue>{setMoneyRegex(goal)}원</S.DetailValue>
      </S.DetailContainer>
      <S.DetailContainer>
        <S.DetailKey>회비</S.DetailKey>
